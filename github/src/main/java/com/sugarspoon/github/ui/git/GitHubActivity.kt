...
import com.sugarspoon.core.views.MessageDialogFactory
import com.sugarspoon.github.databinding.ActivityGithubBinding
import com.sugarspoon.github.model.local.RepositoryEntity
import com.sugarspoon.github.ui.details.DetailsActivity.Companion.onDetailsIntent
...
class GitHubActivity : BaseActivity<ActivityGithubBinding>(ActivityGithubBinding::inflate) {
    ...
    private fun setupUi() = with(binding) {
        ...
        gitHubListRv.apply {
            ...
            addVeiledItems(com.sugarspoon.github.ui.git.GitHubActivity.DEFAULT_SHIMMER)
        }
    }
